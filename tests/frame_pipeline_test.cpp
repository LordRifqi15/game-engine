...
// Build: g++ -std=c++17 -I../include -I../third_party -I../third_party/imgui ../src/renderer/Renderer.cpp ../src/renderer/FrameContext.cpp ../src/renderer/graph/RenderGraph.cpp ../src/renderer/graph/RenderGraphBuilder.cpp ../src/renderer/graph/RenderGraphResources.cpp ../src/renderer/graph/RenderGraphValidator.cpp ../src/renderer/graph/ResourceLifetime.cpp ../src/renderer/graph/TransientResourcePool.cpp ../src/renderer/scheduler/FrameScheduler.cpp ../src/renderer/scheduler/TimelineSync.cpp ../src/renderer/vulkan/VkBarrierHelper.cpp ../src/renderer/vulkan/VkDeviceMemoryHelper.cpp ../src/renderer/deferred/GBuffer.cpp ../third_party/imgui/imgui.cpp ../third_party/imgui/imgui_draw.cpp ../third_party/imgui/imgui_tables.cpp ../third_party/imgui/imgui_widgets.cpp ../third_party/imgui/backends/imgui_impl_glfw.cpp ../third_party/imgui/backends/imgui_impl_vulkan.cpp frame_pipeline_test.cpp -o /tmp/frame_pipeline_test -lvulkan -lglfw && /tmp/frame_pipeline_test
